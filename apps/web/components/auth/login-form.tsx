...
import type { LoginInput } from '@free2talk/shared';
    ...
    const handleSubmit = useCallback(
        async (e: FormEvent) => {
            ...
            try {
                ...
                // Error is handled by the hook and stored in authError
        ...
        <Card className="w-full max-w-md p-8 bg-surface-elevated border-surface-border">
            <div className="space-y-6">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-muted-foreground">Sign in to continue to Free2Talk</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input
                                type="checkbox"
                                className="rounded border-surface-border bg-surface text-primary-500 focus:ring-primary-500"
                            />
